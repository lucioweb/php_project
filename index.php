...
<body>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown"
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="#">Instalando módulos</a></li>
                            <li><a class="dropdown-item" href="#">Listando módulos</a></li>
                            <li><a class="dropdown-item" href="#">Verificando a versão</a></li>
                            <li><a class="dropdown-item" href="#">Criando virtualHost</a></li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="#">Instalando módulos</a></li>
                            <li><a class="dropdown-item" href="#">Listando módulos</a></li>
                            <li><a class="dropdown-item" href="https://www.php.net/">Documentação</a></li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
                            <li><a class="dropdown-item" href="https://www.php-fig.org/">PHP-FIG</a></li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
                            <li><a class="dropdown-item"
                                    href="https://www.jetbrains.com/help/phpstorm/getting-started.html">PhpStorm</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown"
                            aria-expanded="false">UBUNTU</a>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="#">Verificando a versão</a></li>
                            <li><a class="dropdown-item" href="#">Atualizando os repositórios</a></li>
                            <li><a class="dropdown-item" href="#">Gerenciando usuários e grupos</a></li>
                            <li><a class="dropdown-item" href="#">Manipulando arquivos e diretórios</a></li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
                            <li><a class="dropdown-item" href="#">WSL</a></li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
    ...
    <div class="container pt-5 my-5">
        <div class="p-5 text-center bg-body-tertiary rounded-3">
            ...
            <h1 class="text-body-emphasis">Full Stack PHP Developer</h1>
            <p class="col-lg-8 mx-auto fs-5 text-muted">
                PHP 8.3.6, Apache2 e MySql 8.0.36 em Ubuntu 24.04 LTS, VSCode, localhost
            </p>
    ...
    <div class="container pt-5">
        <footer class="py-3 my-2">
            <ul class="nav justify-content-center border-bottom pb-3 mb-3">
                ...
                <li class="nav-item"><a href="#" class="nav-link px-2 text-body-secondary">Apache</a></li>
                <li class="nav-item"><a href="#" class="nav-link px-2 text-body-secondary">PHP</a></li>
                <li class="nav-item"><a href="#" class="nav-link px-2 text-body-secondary">MySQL</a></li>
                <li class="nav-item"><a href="#" class="nav-link px-2 text-body-secondary">Composer</a></li>
                <li class="nav-item"><a href="#" class="nav-link px-2 text-body-secondary">Bootstrap</a></li>
                <li class="nav-item"><a href="#" class="nav-link px-2 text-body-secondary">Ubuntu</a></li>
                <li class="nav-item"><a href="#" class="nav-link px-2 text-body-secondary">PHPStorm</a></li>
            </ul>
            <p class="text-center text-body-secondary">&copy; 2024 FSPHP Developer</p>
        </footer>
    </div>
